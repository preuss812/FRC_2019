...
public class ADIS16448_IMU extends GyroBase implements Gyro, PIDSource {
  ...
  public ADIS16448_IMU(Axis yaw_axis, AHRSAlgorithm algorithm) {
    ...
    System.out.println("about to check read register");
    // Validate the product ID
    int actual = 0;
    if ((actual = readRegister(kRegPROD_ID)) != 16448) {
      System.out.println("failed to readRegister. actual is: " + actual);
      m_spi.free();
      m_spi = null;
      m_samples = null;
    ...
    System.out.println("successfully read register");
