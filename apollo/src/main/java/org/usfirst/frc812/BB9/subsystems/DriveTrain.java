...
//    	lastY = -powerTrim(js.getRawAxis(1)); // right  joystick Y axis == 1
    	...
    	Robot.nttable.getEntry("Quick turn:").getBoolean(Robot.quick_turn);
    	robotDrive.curvatureDrive(lastY, lastX, Robot.quick_turn);
    }
	...
	public void stop() {
    	robotDrive.curvatureDrive(0.0, 0.0, false);
    }
