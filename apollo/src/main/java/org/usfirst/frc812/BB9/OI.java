...
public class OI {
 ...
 //   public Joystick controlBox;
    ...
    public Button backDown;
    public Button allUp;
    public Button allDown;
 ...
 //       controlBox = new Joystick(3);
	...
	// - see command/DriveWithJoysticks.java
        ...
        frontDown = new JoystickButton(xboxController, 1);
        backDown  = new JoystickButton(xboxController, 2);
        backUp    = new JoystickButton(xboxController, 3);
        frontUp   = new JoystickButton(xboxController, 4);
        allDown   = new JoystickButton(xboxController, 5);
        allUp     = new JoystickButton(xboxController, 6);
...
*/
        frontUp.whenPressed(new PistonLiftCommand(0));
        frontDown.whenPressed(new PistonLiftCommand(1));
        backUp.whenPressed(new PistonLiftCommand(2));
        backDown.whenPressed(new PistonLiftCommand(3));
        allUp.whenPressed(new PistonLiftCommand(4));
        allDown.whenPressed(new PistonLiftCommand(5));
        ...
        double timeout = Robot.controlBoxSubsystem.getPotValueScaled(0,0.5, 5.0);
