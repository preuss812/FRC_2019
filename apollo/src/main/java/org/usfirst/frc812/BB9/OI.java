...
*/
        frontUp.whenPressed(new PistonLiftGroupCommand(0));
        frontDown.whenPressed(new PistonLiftGroupCommand(1));
        backUp.whenPressed(new PistonLiftGroupCommand(2));
        backDown.whenPressed(new PistonLiftGroupCommand(3));
        allUp.whenPressed(new PistonLiftGroupCommand(6)); // #6 sequences lift commands
        allDown.whenPressed(new PistonLiftGroupCommand(5));
